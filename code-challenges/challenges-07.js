...
const objLat = (obj) => {
    return `my name is ${obj.firstName.charAt(0).toUpperCase() + obj.firstName.substr(1).toLowerCase()} ${obj.lastName.charAt(0).toUpperCase() + obj.lastName.substr(1).toLowerCase()} I am ${obj.age} YO, and I love ${obj.hobby}.`;
};
// -------------------------------------------------------------------------------------------------------
